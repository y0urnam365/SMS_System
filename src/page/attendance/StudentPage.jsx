...
const StudentPage = () => {
  const studentsData = [
    { key: '1', id: '024555', name: 'សុខ ហេង', gender: 'ប្រុស', status: 'present' },
    { key: '2', id: '024556', name: 'ចាន់ ធីតា', gender: 'ស្រី', status: 'late' },
    { key: '3', id: '024557', name: 'វីរៈ ជាតិ', gender: 'ប្រុស', status: 'absent' },
    { key: '4', id: '024558', name: 'លី ម៉ារី', gender: 'ស្រី', status: 'permission' },
  ];
  ...
  return (
    <Layout style={{ minHeight: '100vh', background: '#f4f7f9' }}>
      <Header style={{ background: '#fff', padding: '0 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
        <div>
          <Title level={3} style={{ margin: 0, color: '#1890ff' }}>វត្តមានសិស្ស</Title>
          <Text type="secondary">ប្រព័ន្ធគ្រប់គ្រងវត្តមានសិស្សប្រចាំថ្ងៃ</Text>
        </div>
      </Header>
      ...
      <Content style={{ padding: '24px 40px' }}>
        <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
          ...
          {/* Table Card */}
          <Card 
            title={<span><CheckCircleOutlined style={{ color: '#52c41a' }} /> បញ្ជីឈ្មោះសិស្សសម្រាប់កត់វត្តមាន</span>}
            bodyStyle={{ padding: 0 }}
